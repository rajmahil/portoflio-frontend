...
import AdditionalPageHeader from "../Components/AdditionalPageHeader";
import { AddPagesContainer } from "./privacy";

const termsandconditions = () => {
  return (
    <>
      <AdditionalPageHeader title="Terms and Conditions" />
      <AddPagesContainer>
        <h2>
          <strong>Terms and Conditions</strong>
        </h2>

        <p>Welcome to Raj Mahil!</p>
        ...
        <p>
          ...
          conditions. Do not continue to use Raj Mahil if you do not agree to
        ...
        <p>
          Unless otherwise stated, Raj Mahil and/or its licensors own the
          intellectual property rights for all material on Raj Mahil. All
          intellectual property rights are reserved. You may access this from
          Raj Mahil for your own personal use subjected to restrictions set in
          these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from Raj Mahil</li>
          <li>Sell, rent or sub-license material from Raj Mahil</li>
          <li>Reproduce, duplicate or copy material from Raj Mahil</li>
          <li>Redistribute content from Raj Mahil</li>
        </ul>
        ...
        <p>
          ...
          exchange opinions and information in certain areas of the website. Raj
          Mahil does not filter, edit, publish or review Comments prior to their
          presence on the website. Comments do not reflect the views and
          opinions of Raj Mahil,its agents and/or affiliates. Comments reflect
          the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, Raj Mahil shall
        ...
        <p>
          Raj Mahil reserves the right to monitor all Comments and to remove any
        ...
        <p>
          You hereby grant Raj Mahil a non-exclusive license to use, reproduce,
        ...
        <p>
          ...
          the hyperlink compensates the absence of Raj Mahil; and (d) the link
        ...
        <p>
          ...
          sending an e-mail to Raj Mahil. Please include your name, your
